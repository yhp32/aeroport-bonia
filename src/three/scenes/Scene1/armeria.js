      ...
      >
        ...
        >
          <Box sx={{ lineHeight: 0 }}>
            ...
            >
              <SuspenseImage src="/images/bag_armeria.jpg" draggable={false} />
              <SuspenseImage src="/images/bag_armeria_2.png" draggable={false} />
            </Carousel>
          </Box>
          ...
          >
            ...
            <Text
              ...
              color="white"
            >
              <I18n t="armeriaBag.content" />
            </Text>
            <Box p={[12, 6, 5, 5, 5, 6]} />
            <a href="https://www.bonia.com/collections/armeria" target="_blank" rel="noreferrer">
              <Button
                variant="primary"
                bg="armeriaButton"
          ...
          >
            ...
            >
              ...
              <Button
                ...
                onClick={() => {
                  window.open('https://www.bonia.com/collections/armeria')
                }}
              >
                <I18n t="armeriaBag.preorder" />
              </Button>
            ...
            >
              ...
              <Button
                ...
                onClick={() => {
                  window.open('https://www.bonia.com/')
                }}
              >
                <I18n t="armeriaBag.preorder" />
              </Button>
